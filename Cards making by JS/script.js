const users = [
  ...
  users.forEach(function(elem){
    sum = sum + `<div class="card">
        <div class="imgs">
            <img class="backimg" src="${elem.coverPhoto}" alt="">
            <img class="profileimg" src="${elem.profilePhoto}" alt="">
        </div>

        <div class="data">
                <h1 class="username">${elem.username}</h1>
                <h2 class="fullname">${elem.fullName}</h2>
                <p class="discription">${elem.description}</p>
        </div>
        ...
        <div class="nums">
            ...
            <div>
                ...
                <h4 class="h">Followers</h4>
            </div>
            <div>
                <h3>${elem.followingCount}</h3>
                <h4 class="h">Following</h4>
            </div>
        </div>
    </div>`
  })
